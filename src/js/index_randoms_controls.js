...
function performCalculations() {
	...
	for (var i = 0; i < 4; i++) {
		...
		$(resultLocations[0][i].move + " + label").text(p1.moves[i].originalName.replace("Hidden Power", "HP"));
		...
		$(resultLocations[1][i].move + " + label").text(p2.moves[i].originalName.replace("Hidden Power", "HP"));
